 ...
 * 
 * 1. CLICKS - Manual clicking achievements
 *    Examples: First Flakes (100 clicks), Click Deity (1M clicks)
 *    Stats: total_clicks
 * 
...
export const ACHIEVEMENTS = {
  "achievements": [
    // Click Achievements
    {
      "id": "clicks_1",
      "name": "First Flakes",
      "description": "Generate 1 snowball from clicks.",
      "category": "clicks",
      "type": "threshold",
      "condition": {
    ...
    },
    {
      "id": "clicks_10",
      "name": "First Flakes",
      "description": "Generate 10 snowballs from clicks.",
      "category": "clicks",
      "type": "threshold",
      "condition": {
        "stat": "effective_clicks",
    ...
    // Snowballs per Second Achievements
    {
      "id": "snowball_drops",
      "name": "Snowball Drops",
      "description": "Generate 1+ snowballs per second.",
      "category": "sps",
      "type": "threshold",
      "condition": {
        "stat": "sps",
